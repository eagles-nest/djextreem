...
<head>
	...
	<meta name="description" content="This allows you to view djextreme254.co.ke optimized for a mobile device">
	<title>djextreme254 mobile site</title>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>adminfiles/themes/jquery.mobile.structure-1.4.5.min.css" />
	<script src="<?php echo base_url();?>adminfiles/themes/jquery-1.11.1.min.js"></script>
	<script src="<?php echo base_url();?>adminfiles/themes/jquery.mobile-1.4.5.min.js"></script>
</head>
<body>
